  ...
  const handleSubmit = async(color) => {
      ...
      <div className="bg-base-200 my-5 rounded-xl">
        ...
        <div className="flex justify-around py-3">
          {/* You can open the modal using ID.showModal() method */}
          {
            ...
            onClick={() => window.my_modal_4.showModal()}>Green</button> : <button className="btn text-white " disabled
            onClick={() => window.my_modal_4.showModal()}>Green</button>
          }
    ...
    <div>
          ...
          {/* You can open the modal using ID.showModal() method */}
          {
            ...
            onClick={() => window.my_modal_5.showModal()}>Red</button> : <button className="btn btn-accent text-white" disabled
            onClick={() => window.my_modal_5.showModal()}>Red</button>
          }
    ...
    <div>
          ...
          {/* You can open the modal using ID.showModal() method */}
          {
            ...
            onClick={() => window.my_modal_6.showModal()}>Blue</button> : <button className="btn btn-primary text-white" disabled
            onClick={() => window.my_modal_6.showModal()}>Blue</button>
          }
