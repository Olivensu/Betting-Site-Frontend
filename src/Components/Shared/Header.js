...
Home
            ...
            {
              user? <Link  className='m-auto' to='/user'>
              <button className='text-center text-xl'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 m-auto">
  ...
  Login
            ...
            <Link  className='m-auto' to='https://api.whatsapp.com/send/?phone=8801748541038&text&type=phone_number&app_absent=0'  target="_blank">
            <button className='text-center text-xl'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 m-auto">
